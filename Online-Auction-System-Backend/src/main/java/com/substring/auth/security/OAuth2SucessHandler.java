...
public class OAuth2SucessHandler implements AuthenticationSuccessHandler {
	...
	private String frontendSucessUrl;

	private final Logger logger = LoggerFactory.getLogger(this.getClass());

	OAuth2SucessHandler(JwtAuthanticationFilter jwtAuthanticationFilter, UserRepository userRepository,
			JwtService jwtService, CookieService cookieService, RefreshTokenRepository refreshTokenRepository) {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		logger.info("successful authantication");
		...
		//refresh:
//		user->refersh token revoke karna hai 
...
//		response.getWriter().write("Login Sucessful");
		
		response.sendRedirect(frontendSucessUrl);
		// refresh:
