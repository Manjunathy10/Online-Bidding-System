...
public class JwtAuthanticationFilter extends OncePerRequestFilter {
	...
	private Logger logger = LoggerFactory.getLogger(JwtAuthanticationFilter.class);
			...
			try {
				...
				userRepository.findById(userUuid).ifPresent(user -> {
					...
					if (user.isEnable()) {
						...
						// final line that shoud check the security context
				...
				request.setAttribute("error", "Token Expried");
//				e.printStackTrace();
